  ...
  try {
    ...
    const result = await pool.query(`
      SELECT
        ...
        relationship_to_patient AS "relationshipToPatient",
        patient_is_minor AS "patientIsMinor",
        guardian_authorization AS "guardianAuthorization",
        street_address AS "streetAddress",
        address_details AS "addressDetails",
        town,
        state,
        zip_code AS "zipCode",
        preferred_lab AS "preferredLab",
        prescription_ready AS "prescriptionReady",
        has_kit AS "hasKit",
        patient_count AS "patientCount",
        kit_count AS "kitCount",
        quoted_price_cents AS "quotedPriceCents",
